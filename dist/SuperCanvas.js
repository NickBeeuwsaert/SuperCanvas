...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Matrix = exports.Path = undefined;
	exports.SuperCanvas = SuperCanvas;
	...
	function SuperCanvas(canvas) {
	    if (!canvas) {
	        throw new Error("Need an argument");
	    }

	    if (canvas.canvas) {
	        //We got a context instance
	...
	SuperCanvas.fn = {
	    ...
	    drawPath: function drawPath(d, transform) {
	        //var ctx = this.context;
	        var t = this;
	        t.beginPath();
	        _Path.Path.each(d, function (segment) {
	...
	['beginPath', 'closePath', 'lineTo', 'moveTo', 'bezierCurveTo', 'quadraticCurveTo', 'translate', 'rotate', 'scale', 'save', 'restore', 'fillText', 'stroke', 'fill'].forEach(function (cmd) {
